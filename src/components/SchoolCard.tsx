...
export default function SchoolCard({ school }: SchoolCardProps) {
  ...
  const totalRecords = school.statistics.total_records;
  const submittedCount = school.statistics.submitted_count;
  const completionPercentage = totalRecords > 0
    ? Math.round((submittedCount / totalRecords) * 100)
    : 0;

  return (
    <div
      onClick={() => router.push(`/onboarding/${school.school_id}`)}
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-2">
            ...
            <div className="text-xl font-bold text-gray-900 dark:text-gray-100">{school.statistics.total_records}</div>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-950 rounded-lg p-2">
            ...
            <div className="text-xl font-bold text-green-700 dark:text-green-400">{school.statistics.validated_count}</div>
          </div>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-950 rounded-lg p-2">
            ...
            <div className="text-xl font-bold text-yellow-700 dark:text-yellow-400">{school.statistics.pending_count}</div>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-950 rounded-lg p-2">
            ...
            <div className="text-xl font-bold text-blue-700 dark:text-blue-400">{school.statistics.submitted_count}</div>
          </div>
        </div>
